...
if Manager(msg) then
if DevAli:get(WaNsPeEd.."Ali:Lock:ProNames"..msg.chat_id_) then
local Txt = text:match("^وضع توحيد (.*)$") or text:match("^ضع توحيد (.*)$")
send(msg.chat_id_, msg.id_,'⌁︙تم تعيين ↫ '..Txt..' كتوحيد للمجموعه')
DevAli:set(WaNsPeEd.."Ali:ProNames:Txt"..msg.chat_id_,Txt)
else
...
DevAli:set(WaNsPeEd.."Ali:ProNames:Num"..msg.chat_id_,Num)
else
send(msg.chat_id_, msg.id_,'⌁︙ميزة التوحيد معطله يرجى تفعيلها')
end
end
...
if DevAli:get(WaNsPeEd.."Ali:ProNames:Txt"..msg.chat_id_) then
local ProNamesTxt = DevAli:get(WaNsPeEd.."Ali:ProNames:Txt"..msg.chat_id_)
local ProNamesNum = DevAli:get(WaNsPeEd.."Ali:ProNames:Num"..msg.chat_id_) or 5
...
if DevAli:get(WaNsPeEd.."Ali:Lock:ProNames"..msg.chat_id_) and DevAli:get(WaNsPeEd.."Ali:ProNames:Txt"..msg.chat_id_) then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result and result.first_name_ then 
if result.first_name_:match("(.*)"..DevAli:get(WaNsPeEd.."Ali:ProNames:Txt"..msg.chat_id_).."(.*)") then 
DevAli:srem(WaNsPeEd..'Ali:Muted:'..msg.chat_id_, msg.sender_user_id_)
else
local ProNamesTxt = DevAli:get(WaNsPeEd.."Ali:ProNames:Num"..msg.chat_id_) or 5
local UserNum = DevAli:get(WaNsPeEd.."Ali:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(UserNum) == tonumber(ProNamesTxt) or tonumber(UserNum) > tonumber(ProNamesTxt)) then 
DevAli:sadd(WaNsPeEd..'Ali:Muted:'..msg.chat_id_, msg.sender_user_id_)
DevAli:del(WaNsPeEd.."Ali:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_)
...
DevAli:incrby(WaNsPeEd.."Ali:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌁︙عذرا عزيزي ↫ ["..result.first_name_.."](https://t.me/"..(result.username_ or "Dev_Prox")..")\n⌁︙عليك وضع التوحيد ↫ `"..DevAli:get(WaNsPeEd.."Ali:ProNames:Txt"..msg.chat_id_).."` بجانب اسمك\n⌁︙عدد المحاولات المتبقيه ↫ "..(tonumber(ProNamesTxt) - tonumber(UserNum)).."")
end
end
end
end,nil)
...
DevAli:set(WaNsPeEd.."Ali:Lock:ProNames"..msg.chat_id_,true)
end
if text == "تعطيل التوحيد" and Constructor(msg) then
send(msg.chat_id_, msg.id_, '⌁︙تم تعطيل توحيد المجموعه')
DevAli:del(WaNsPeEd.."Ali:Lock:ProNames"..msg.chat_id_)
end
end
