...
if result.id_ then 
local Alli = DevAli:get("WaNsPeEdTEAM:Photo"..result.id_)
if not result.profile_photo_ then 
if Alli then 
Dev_Ali(msg.chat_id_, msg.id_, 1, "حذف كل صوره مضروب بوري، 😹💔", 1, 'html')
DevAli:del("WaNsPeEdTEAM:Photo"..result.id_) 
end
end
...
DevAli:set("WaNsPeEdTEAM:Photo"..result.id_, result.profile_photo_.big_.persistent_id_) 
end
end
end,nil) 
end
