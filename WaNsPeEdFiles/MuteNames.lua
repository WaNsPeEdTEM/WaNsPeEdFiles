...
if DevAli:get(WaNsPeEd.."Ali:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAli:sadd(WaNsPeEd.."Ali:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevAli:get(WaNsPeEd.."Ali:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
WaNsPeEdName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if WaNsPeEdName then 
WaNsPeEdNames = DevAli:smembers(WaNsPeEd.."Ali:Mute:Names"..msg.chat_id_) or ""
if WaNsPeEdNames and WaNsPeEdNames[1] then 
for i=1,#WaNsPeEdNames do 
if WaNsPeEdName:match("(.*)("..WaNsPeEdNames[i]..")(.*)") then 
...
DevAli:set(WaNsPeEd.."Ali:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAli:del(WaNsPeEd.."Ali:Lock:MuteNames"..msg.chat_id_)
end
end
end
